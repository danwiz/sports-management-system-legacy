...
void Player_Menu_Choice(int);
int Player_Menu_Display();
...
void Main_Menu_Choice( char menu)
{
	...
	switch(menu)
   {
      ...
      case '3':
      	...
      	Player_Menu_Choice(Player_Menu_Display());
         break;
      case '4':
         ExitPro();
      	//End();
...
int Player_Menu_Display()
{
   ...
   g.display(25, 6,LIGHTRED,WHITE,"   \1\1    Player Management   \1\1     ");
   g.display(36, 7,BLUE,WHITE,"\38\38");
   g.display(48, 7,BLUE,WHITE,"\38\38");
   textcolor(2);
   g.display(25, 10,LIGHTBLUE,WHITE," Create Player") ;
       ...
       g.Go();//unhides the cursor
  	     if(pos==1)
         {
            g.display(20,  11,WHITE,WHITE,"2.");
			  ...
			  g.display(23,10,LIGHTBLUE,LIGHTGRAY,"            \20 ");
		     g.display(37,10,WHITE,LIGHTMAGENTA," CREATE A NEW PLAYER ");
           ...
           g.display(23,14,LIGHTBLUE,WHITE,"   Return To Main Menu                        ") ;
           g.display(1,25,BLACK,LIGHTGRAY, " CREATES A NEW PLAYER PREPARE FOR DATA ENTRY, MEMBER: NAME,ADDRESS, ETC...     ");
           gotoxy(41, 17);
         }
         else
         {
...
//======================================================
//soccer Player Menu choice   picks the  choice of the user
//======================================================
void Player_Menu_Choice( int menu)
{
   GRAPHIX g;
...
void ViewPlayers()
{
   ...
   g.display(1,1,YELLOW,BLUE,      " SPORTS MANAGEMENT SYSTEM                                                       ");
   g.display(30,4,YELLOW,BLACK, "VIEW PLAYER DATA");
   g.display(1,5,WHITE,BLACK,      "________________________________________________________________________________");
...
void DelPlayer()
{
   ...
   g.display(1,1,YELLOW,BLUE,      " SPORTS MANAGEMENT SYSTEM                                                       ");
   g.display(30,4,YELLOW,BLACK, "DELETE PLAYER DATA");
   ...
   if(mread.SearchFile(id)) //if the id number could not be found
   {
      ...
      if(mread.WriteToFile(player.getMemberID(),mblank))
   	...
   	g.display(1,10,WHITE,BLACK, "Player Doesn't Exist!!");
   getch();
   ...
   bool draw;
    ...
    if(MatchType==1)
    {
      ...
      if(sread.SearchFile(id)) //searches the user file for this ID number
      {
         ...
         g.display(1,13,WHITE,BLACK, "________________________________________________________________________________");
         cout<<endl;
         socmatch newSoc = sread.ReadFromFile(id);
      ...
      getch();
 		...
 		if(MatchType==2)
    	{
      	...
      	cin>>id; //accepts users input
      	if(nread.SearchFile(id)) //searches the user file for this ID number
      	{
            //g.display(25,1,WHITE,BLACK, "                                                                               ");
         	...
         	g.display(1,13,WHITE,BLACK, "________________________________________________________________________________");
         	cout<<endl;
         	netmatch newNet = nread.ReadFromFile(id);
      ...
      getch();
    	...
    	if(MatchType==3)
    	{
      	...
      	if(tread.SearchFile(id)) //searches the user file for this ID number
      	{
         	...
         	g.display(1,13,WHITE,BLACK, "________________________________________________________________________________");
         	cout<<endl;
         	trackmatch newTrack = tread.ReadFromFile(id);
            ...
            newTrack.setFTime(ftime);
         	...
         	{
         		g.display(25,23,YELLOW,BLACK,"Track & Feild Database updated successfully....");
            	if( (MessageBox(NULL,TEXT("Do you want Edit another Track Match?"),TEXT("Finish"),MB_YESNO | MB_ICONQUESTION)) == IDYES)
            		EditMatch(3); //calls the procedure to create Player
         	}
         	else
         		g.display(25,23,YELLOW,BLACK,"Problem Updating Database....");
         }
         else
         	g.display(25,23,YELLOW,BLACK,"Track & Field Match Doesn't Exist");
     		getch();
    	}
